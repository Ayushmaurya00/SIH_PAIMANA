      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-200 pb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            title="Delete Project from monitoring directory"
            aria-label="Delete Project from monitoring directory"
            className="text-xs flex items-center gap-1.5 py-1.5 px-3 rounded-lg transition-colors border border-red-200 text-red-600 hover:bg-red-50 cursor-pointer"
          >
